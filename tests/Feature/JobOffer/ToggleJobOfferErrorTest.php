...
class ToggleJobOfferErrorTest extends TestCase
{
    public function test_the_toggle_job_offer_endpoint_error(): void
    {
        ...
        $protectedResponse = $this->withToken($token)->put("/api/job-offers/0/toggle-status");

...
class DeleteJobOfferSuccessTest extends TestCase
{
    public function test_the_delete_job_offer_endpoint_success(): void
    {
        ...
        $jobOffer = JobOffer::latest()->firstOrFail();
        $protectedResponse = $this->withToken($token)->delete("/api/job-offers/{$jobOffer->id}");

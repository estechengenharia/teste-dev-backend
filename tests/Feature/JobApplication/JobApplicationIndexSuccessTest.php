...
class JobApplicationIndexSuccessTest extends TestCase
{
    public function test_the_job_offer_application_index_endpoint_success(): void
    {
        ...
        $protectedResponse = $this->withToken($token)->get('/api/applications');

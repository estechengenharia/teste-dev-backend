...
class CreateJobApplicationSuccessTest extends TestCase
{
    public function test_the_create_job_offer_application_endpoint_success()
    {
        ...
        $protectedApplicationResponse->assertStatus(201);
    }
}

...
class GetUserApplicationsSuccessTest extends TestCase
{
    public function test_the_get_job_offer_application_endpoint_success(): void
    {
        ...
        $userJobApplication = UserJobOfferApplication::firstOrFail();
        $protectedResponse = $this->withToken($token)->get("/api/applications/user/$userJobApplication->user_id");
